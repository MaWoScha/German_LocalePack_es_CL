 ...
 */
class German_LocalePackCl_Model_Observer {

    public function adminhtmlControllerActionPredispatchStart() {

        $helper = Mage::helper("localepackcl");
    ...
    public function getVersionNumber() {
        ...
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackCl/version');
    }
    ...
    public function getManageUrl() {
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackcl'));
    }
}
